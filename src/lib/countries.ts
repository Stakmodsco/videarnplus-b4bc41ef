// All ISO 3166-1 countries with their flag, region & default suggested
// payment method. The Payment page consults this list together with the
...
const RAW: { code: string; name: string; scope?: "ZA" | "GH" }[] = [
  ...
  { code: "DE", name: "Germany" }, { code: "GH", name: "Ghana", scope: "GH" }, { code: "GI", name: "Gibraltar" },
  ...
  { code: "QA", name: "Qatar" }, { code: "CG", name: "Republic of the Congo" }, { code: "RE", name: "Réunion" },
  { code: "RO", name: "Romania" }, { code: "RU", name: "Russia" }, { code: "RW", name: "Rwanda" },
  { code: "BL", name: "Saint Barthélemy" }, { code: "SH", name: "Saint Helena" }, { code: "KN", name: "Saint Kitts & Nevis" },
  { code: "LC", name: "Saint Lucia" }, { code: "MF", name: "Saint Martin" }, { code: "PM", name: "Saint Pierre & Miquelon" },
  ...
  { code: "ZA", name: "South Africa", scope: "ZA" }, { code: "KR", name: "South Korea" }, { code: "SS", name: "South Sudan" },
  ...
  { code: "WF", name: "Wallis & Futuna" }, { code: "EH", name: "Western Sahara" }, { code: "YE", name: "Yemen" },
...
export const findCountryByCode = (code?: string | null): CountryEntry | null => {
  ...
  return ALL_COUNTRIES.find((x) => x.code === c) ?? null;
};
